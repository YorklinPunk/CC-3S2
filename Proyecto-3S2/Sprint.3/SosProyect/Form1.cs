...
namespace SosProyect
{
    public partial class Form1 : Form
    {
        ...
        {
            //SE INICIA UNA VARIABLE QUE CONTENDRÁ UNA CANTIDAD LIMITE PARA FINALIZAR EL JUEGO
        ...
        public void searchSOS(string letter ,int i ,int j)
        {
            if(letter == "S")
            {
                if(searchSOSWithLetterS(i, j))
                {
                    if(getTurn() == "Red"){
                        contRed += 1;
                    }
